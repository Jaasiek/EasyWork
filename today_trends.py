...
def today_trends_fcpxml(file):
    ...
    metadata_out_today_trends, "md", key="com.apple.proapps.studio.cameraISO", value="0"
)
    ...
    metadata_in_today_trends, "md", key="com.apple.proapps.studio.cameraISO", value="0"
)
    ...
    metadata_in_today_trends, "md", key="com.apple.proapps.studio.cameraColorTemperature"
)
    ...
    string2_in_today_trends = ET.SubElement(md5_in_today_trends, "string")
    ...
    library_today_trends, "smart-collection", name="Favourites", match="all"
)
    match_ratings1_smart_collection4_today_trends = ET.SubElement(
    smart_collection5_today_trends, "match-ratings", value="favourites"
)
    ...
    fcpxml_string_today_trends = ET.tostring(fcpxml_root_today_trends, encoding="unicode")

    fcpxml_today_trends = header + fcpxml_string_today_trends

    file.write(fcpxml_today_trends)