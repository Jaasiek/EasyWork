...
md3_out_early_news = ET.SubElement(
    metadata_out_early_news, "md", key="com.apple.proapps.studio.cameraISO", value="0"
)
...
md3_in_early_news = ET.SubElement(
    metadata_in_early_news, "md", key="com.apple.proapps.studio.cameraISO", value="0"
)
...
md5_in_early_news = ET.SubElement(
    metadata_in_early_news, "md", key="com.apple.proapps.studio.cameraColorTemperature"
)
...
md6_in_early_news = ET.SubElement(
    ...
    "md",
    key="com.apple.proapps.mio.ingestDate",
    value="2024-03-26 46:37:46 + 0100",
)
