...
def tonight_talks_fcpxml(file, library_location, event_name, path):
    ...
    string2_in_tonight_talks = ET.SubElement(array_md5_in_tonight_talks, "string")
    ...
    smart_collection5_tonight_talks = ET.SubElement(
        library_tonight_talks, "smart-collection", name="Favorites", match="all"
    )
    match_ratings1_smart_collection4_tonight_talks = ET.SubElement(
        smart_collection5_tonight_talks, "match-ratings", value="favorites"
    )
