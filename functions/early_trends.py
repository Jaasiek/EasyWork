...
def early_trends_fcpxml(file, library_location, event_name, name):
    ...
    metadata_out_early_trends, "md", key="com.apple.proapps.studio.cameraISO", value="0"
)
    ...
    metadata_in_early_trends, "md", key="com.apple.proapps.studio.cameraISO", value="0"
)
    ...
    metadata_in_early_trends, "md", key="com.apple.proapps.studio.cameraColorTemperature"
)
    ...
    library_early_trends, "smart-collection", name="Favourites", match="all"
)
    match_ratings1_smart_collection4_early_trends = ET.SubElement(
    smart_collection5_early_trends, "match-ratings", value="favourites"
)
