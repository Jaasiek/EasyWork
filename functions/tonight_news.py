...
def tonight_news_fcpxml(file, library_location, event_name, name):
    ...
    metadata_out_tonight_news, "md", key="com.apple.proapps.studio.cameraISO", value="0"
)
    ...
    metadata_in_tonight_news, "md", key="com.apple.proapps.studio.cameraISO", value="0"
)
    ...
    metadata_in_tonight_news, "md", key="com.apple.proapps.studio.cameraColorTemperature"
)
    ...
    library_tonight_news, "smart-collection", name="Favourites", match="all"
)
    match_ratings1_smart_collection4_tonight_news = ET.SubElement(
    smart_collection5_tonight_news, "match-ratings", value="favourites"
)
    ...
    fcpxml_string_tonight_news = ET.tostring(fcpxml_root_tonight_news, encoding="unicode")

    fcpxml_tonight_news = header + fcpxml_string_tonight_news

    file.write(fcpxml_tonight_news)