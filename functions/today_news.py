...
def today_news_fcpxml(file, library_location, event_name, name):
    ...
    metadata_out_today_news, "md", key="com.apple.proapps.studio.cameraISO", value="0"
)
    ...
    metadata_in_today_news, "md", key="com.apple.proapps.studio.cameraISO", value="0"
)
    ...
    metadata_in_today_news, "md", key="com.apple.proapps.studio.cameraColorTemperature"
)
    ...
    library_today_news, "smart-collection", name="Favourites", match="all"
)
    match_ratings1_smart_collection4_today_news = ET.SubElement(
    smart_collection5_today_news, "match-ratings", value="favourites"
)
