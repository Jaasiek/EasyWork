...
def tonight_talks_fcpxml(file, library_location, event_name, name):
    ...
    metadata_out_tonight_talks, "md", key="com.apple.proapps.studio.cameraISO", value="0"
)
    ...
    metadata_out_tonight_talks, "md", key="com.apple.proapps.spotlight.kMDItemCodecs"
)
    ...
    metadata_in_tonight_talks, "md", key="com.apple.proapps.studio.cameraISO", value="0"
)
    ...
    metadata_in_tonight_talks, "md", key="com.apple.proapps.studio.cameraColorTemperature"
)
    ...
    fcpxml_string_tonight_talks = ET.tostring(fcpxml_root_tonight_talks, encoding="unicode")
