...
def early_talks_fcpxml(file, library_location, event_name, name):
    ...
    metadata_out_early_talks, "md", key="com.apple.proapps.studio.cameraISO", value="0"
)
    ...
    metadata_in_early_talks, "md", key="com.apple.proapps.studio.cameraISO", value="0"
)
    ...
    metadata_in_early_talks, "md", key="com.apple.proapps.studio.cameraColorTemperature"
)
